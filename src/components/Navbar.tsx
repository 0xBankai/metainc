        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#how-to-buy" className="hover:text-purple-400 transition-colors">How to Buy</a>
              <a href="#risks" className="hover:text-purple-400 transition-colors">Risks</a>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-black/90">
            ...
            <a href="#how-to-buy" className="block px-3 py-2 hover:text-purple-400">How to Buy</a>
            <a href="#risks" className="block px-3 py-2 hover:text-purple-400">Risks</a>
